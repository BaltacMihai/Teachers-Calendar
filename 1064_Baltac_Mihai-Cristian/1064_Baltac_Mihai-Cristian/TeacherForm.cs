    ...
    public partial class TeacherForm : Form
    {
        ...
        private void populateListView()
        {
            ...
            foreach (Teacher t in teachers)
            {
                ListViewItem lvi = new ListViewItem(new String[]
                    { t.Name, t.Adress,  t.PhoneNumber.ToString() , t.Email, t.Subject});
        ...
        private void tbSubject_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(Subject) ||
             Subject.Length < 5)
            {
                epSubject.SetError(tbSubject, "The subject must be > 5 characters");
                e.Cancel = true;
            }
        }
        ...
        private void txtExp_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                writer.WriteLine("Name Adress PhoneNumber Email Subject");
                foreach (Teacher t in teachers)
                {
